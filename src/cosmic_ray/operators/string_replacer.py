...
class StringReplacer(Operator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.filtered_functions = set(self._op_config.get('filter-if-called-by', ()))
        self.replace_with = self._op_config.get('replace-with', "COSMIC %s RAY")
    ...
    def _is_module_docstring(node):
        ...
        """
        return ObjTest(node).match(String). \
